function OtherNews() {
    return (
        <div className="flex flex-col justify-center items-center bg-background-gray-usu mt-16 lg:px-16 px:8">
            <div className="flex justify-center items-center lg:gap-4 w-full h-[41px] lg:h-[44px]">
                <p className="font-semibold text-[8px] text-text-gray-usu lg:text-[10px]">
                    Find Other News
                </p>
            </div>
            <div className="flex md:flex-row flex-col justify-center items-start w-full">
                <div className="gap-2 px-8 pt-4 pb-8 md:w-1/3">
                    <p className="font-normal text-[8px] text-text-gray-usu leading-4">
                        Internasional
                    </p>
                    <p className="font-light text-[14px] text-text-gray-usu leading-[22.4px]">
